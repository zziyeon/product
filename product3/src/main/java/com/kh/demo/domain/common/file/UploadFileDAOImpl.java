...
public class UploadFileDAOImpl implements UploadFileDAO{
  ...
  //조회
  @Override
  public List<UploadFile> getFilesByCodeWithRid(String code, Long rid) {      //컬렉션으로 반환
    StringBuffer sql = new StringBuffer();
    ...
    List<UploadFile> list = jdbcTemplate.query(sql.toString(),
            //BeanPropertyRowMapper이걸 사용하면 db table의 컬럼명(snake case) => 객체(camel case)로 자동 변환됨
